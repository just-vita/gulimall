...
import top.vita.gulimall.ware.dao.WareSkuDao;
import top.vita.gulimall.ware.entity.WareSkuEntity;
import top.vita.gulimall.ware.feign.ProductFeignService;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    @Override
    public List<SkuHasStockVo> getSkusHasStock(List<Long> ids) {

        List<SkuHasStockVo> hasStockVos = ids.stream().map(item -> {
            SkuHasStockVo vo = new SkuHasStockVo();
            Long count = baseMapper.getSkusStock(item);
            vo.setSkuId(item);
