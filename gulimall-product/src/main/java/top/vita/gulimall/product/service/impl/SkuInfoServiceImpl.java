...
//    private SeckillFeignService seckillFeignService;
    ...
    public List<SkuInfoEntity> getSkuInfoBySpuId(Long spuId) {
        ...
        List<SkuInfoEntity> skuInfoEntities = list(lqw);
